  ...
  return (
    <div className="px-4 md:px-24 py-10 pt-20">
      ...
      <div className="shadow-lg p-4 rounded-lg mb-6 flex flex-col md:flex-row justify-between items-start md:items-center">
        <div>
          <h2 className="text-xl md:text-2xl font-bold">Search Result</h2>
          <p className="text-gray-600">49 Active Tour's Found</p>
        </div>
      ...
      <div className="flex flex-col md:flex-row gap-5">
        ...
        <div className="w-full md:w-1/4 space-y-4">
          ...
          <div className="bg-white shadow-lg p-4 rounded-lg">
            <h3 className="text-lg font-semibold">Availability</h3> <hr className="border-gray-300" />
            ...
            />
            <button className="w-full mt-4 bg-[#7BBCB0] text-white p-2 rounded">Check Availability</button>
          </div>
